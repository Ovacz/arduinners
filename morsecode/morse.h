...
{276,92,276,276,0}, {276,276,92,92,0}, {92,276,276,276,276}, {92,92,276,276,276}, {92,92,92,276,276}, {92,92,92,92,276},\
  ...
  for (int i = 0; i < strlength; i++)
  {
    ...
    for (int k = 0; k < 5; k++)
    {
      ...
      else
      {
        ...
        {
          digitalWrite(led, LOW);
          delay(hightime); //in the case of the space hightime is the time to remain LOW.
        }
      }
    }
    delay(276);
